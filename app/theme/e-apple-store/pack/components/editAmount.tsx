...
export default function EditAmount({
  ...
  return (
    ...
    >
      <button className='self-stretch px-4 bg-apple-store-pri text-white rounded-l-2xl'>
        <TextBase>-</TextBase>
      </button>
      <input
        name='amount'
      ...
      />
      <button className='self-stretch px-4 bg-apple-store-pri text-white rounded-r-2xl'>
        <TextBase>+</TextBase>
      </button>
    </div>
  )
